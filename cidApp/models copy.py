...
class Agency(models.Model):
    ...
    created_at = models.DateTimeField(blank=True, null=True)
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='agencies_created')
...
category_status=(
    ('waiting', 'Waiting Report'),
    ('incompleted', 'Incompleted'),
    ('disseminated_rejected', 'Disseminated rejected'),
...
class Subjects(models.Model):
    ...
    status = models.CharField(max_length=300, blank=True, null=True, choices=category_status,default='waiting')
